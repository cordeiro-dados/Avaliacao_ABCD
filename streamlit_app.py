...
pagina_selecionada = st.sidebar.selectbox("Escolha a página", ["Login", "Avaliação ABCD", "Funcionários Data","Alterar Nota"])  # Adicionar nova opção
...
elif pagina_selecionada == "Alterar Nota":  # Nova página
